...
final class ImportQuranicVerses extends Testing
{
     ...
     * @since 1.0.0	 	 
     */
    public function DropFileNameColumnInVerseTables()
	{
     ...
     * @since 1.0.0	 	 
     */
    public function RenameVerseTables()
	{
		/** The database object is fetched */
		$database_obj = $this->GetComponent("database");
		/** The list of all table names is fetched */
	 ...
	 * @param object $mysql_data_object the mysql data object
	 * 
	 * @return int $row_count the number of rows in the verse table
     */
    private function GetTableRowCount($table_name, $file_name, $mysql_data_object)
	{
		...
		$parameters                                    = array("fields"=>"count(*) as total","condition"=>$file_name,"read_all"=>false);
