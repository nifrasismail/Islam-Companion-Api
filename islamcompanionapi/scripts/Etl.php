 ...
 * @link       N.A
 */
final class Etl extends \Framework\Object\DataObjectEtl
{
	/**
     ...
     */
    protected function GetExtractionData()
	{
     ...
     */
    public function GetDivisionData($division_data,$ayat)
	{
    ...
    protected function Load()
	{
		...
		$mysql_data_object->SetConfigurationObject($configuration);
